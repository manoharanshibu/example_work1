...
export default class CustActionButton extends React.Component {
	static defaultProps = {
		idleText: 'Confirm',
	...
	render() {
		...
		return (
			<div className="form-section button-container">
				<button className={cx('c-custom-action-btn btn--primary', this.props.className)} type={this.props.type} onClick={this.props.onClick}>{buttonText}</button>
